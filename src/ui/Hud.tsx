  ...
  return (
    <div className="hud" style={{ ['--accent' as string]: colour }}>
      ...
      <header className="hud-top">
        {ui.chrome.brand && (
          <div className="brand">
            <span className="brand-mark">L.U.M.I.A.</span>
            <span className="brand-sub">Asistente Inteligente Multitarea Ampliamente Útil</span>
          </div>
        )}
      ...
      {ui.chrome.systems && (
        <aside className="rail rail-left">
          ...
          {connected.length === 0 && <div className="rail-item dim">sin enlaces</div>}
          {connected.map((c) => (
      ...
      <footer className="hud-bottom">
        <span className="hint">
          di <b>“Lumi”</b> · <kbd>Espacio</kbd> para hablar · <kbd>G</kbd> manos
          {voice && (
            <>
              {' · '}
